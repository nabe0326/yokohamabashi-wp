			...
			<div class="site-footer__sns">
				<ul class="sns-list">
					<li class="sns-list__item">
						<a href="#" class="sns-list__link" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
					...
					<li class="sns-list__item">
						<a href="#" class="sns-list__link" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
							<svg class="sns-list__icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
					...
					<li class="sns-list__item">
						<a href="#" class="sns-list__link" aria-label="X (Twitter)" target="_blank" rel="noopener noreferrer">
							<svg class="sns-list__icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
